...
def generate_matrix():
    ...
    matrix_with_y = [[randrange(y_min, y_max) for y in range(m)] for x in range(4)]
    return matrix_with_y


def find_average_y(lst):
    average = []
